    ...
    const lettersData = [
        {
            id: 1,
            name: "Gagan",
            msg: "Happy 21st Birthday, my love! You make every day feel like a celebration just by being in it.",
        },
        {
            id: 2,
            name: "Gagan",
            msg: "Every time I see your smile, my heart skips a beat. You have no idea how much you mean to me.",
        },
        {
            id: 3,
            name: "Gagan",
            msg: "Baby, you're the first thing I think about when I wake up and the last thing on my mind before I sleep. You're my everything.",
        },
        {
            id: 4,
            name: "Gagan",
            msg: "I fall more in love with you every single day. Thank you for being the most amazing girlfriend in the world.",
        },
        {
            id: 5,
            name: "Gagan",
            msg: "You're not just my girlfriend, you're my best friend, my soulmate, and the love of my life. I'm so lucky to have you.",
        },
        {
            id: 6,
            name: "Gagan",
            msg: "I promise to love you through every storm, hold you through every tear, and celebrate every victory with you. Forever and always.",
        },
        {
            id: 7,
            name: "Gagan",
            msg: "You make my world complete in ways I never knew possible. I can't imagine my life without you, and I never want to.",
        },
        {
            id: 8,
            name: "Gagan",
            msg: "On your special day, I want you to know that you are loved beyond measure. You deserve all the happiness in the world, my love.",
        },
    ];
                ...
                <div className={`envelope ${openEnvelope ? "active" : ""}`}>
                    ...
                    <div className="munna envelope-flap text-black relative">
                        <div className='munna absolute left-1/2 top-[20%] -translate-x-1/2 flex items-center justify-center flex-col md:gap-y-2'>
                            ...
                            <span className='munna font-dancingScript md:text-3xl text-xl'>Dear Avani</span>
                        </div>
                    </div>
