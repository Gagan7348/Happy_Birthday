      ...
      <div className="book">
        <div className="card card1">
          <div className="card1-content">
            <h2 className="card1-title">Happy Birthday!</h2>
            <div className="card1-decoration">
        ...
        <div className="card card2">
          <div className="card2-content">
            ...
            <div className="card2-message-text italic">
              <article style={{ marginBottom: '8px' }}>Happy 21st Birthday, My Love Avani ❤️</article>
              <article style={{ marginBottom: '10px' }}>From the moment you walked into my life, everything changed—like the universe quietly guiding me toward someone meant for me. You brought light into my darkest days and warmth into places I didn't even know were cold, And you expanded my days with a dimension I can only call my own.</article>
              <article style={{ marginBottom: "10px" }}>Baby, on your special day, I want you to know that you are my everything. You are the first thought in my morning and the last whisper in my night. I promise to love you through every storm, hold you through every tear, and celebrate every victory with you. You are not just my girlfriend—you are my best friend, my soulmate, and the love of my life.</article>
              <article style={{ marginBottom: "10px" }}>Today, as you turn 21, I want to make a promise to you: I will spend every day trying to make you smile, every moment trying to make you feel loved, and every second being grateful that you chose me. You make my world complete, my love. Happy Birthday to the most amazing woman I have ever known.</article>
              <article>you're the reason my life feels softer, brighter, and endlessly worth living. Happy Birthday.</article>
            </div>
            ...
            <p className="signature">Forever Yours, Gagan ❤️</p>
          </div>
        </div>
      </div>
    </div>
